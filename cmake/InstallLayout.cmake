...
fdb_install_packages(TGZ DEB EL8 VERSIONED)
...
copy_install_destinations(DEB EL8)
install_destinations(EL8 LIB usr/lib64)
...
set(LIB_DIR lib64)
configure_file("${mv_packaging_dir}/clients/postinst" "${script_dir}/clients/postinst-el8" @ONLY)
...
set(CPACK_COMPONENT_SERVER-EL8_DEPENDS clients-el8)
...
set(CPACK_RPM_CLIENTS-EL8_PACKAGE_NAME                     "${CPACK_RPM_PACKAGE_NAME}-clients")
set(CPACK_RPM_CLIENTS-EL8_FILE_NAME                        "${CPACK_RPM_CLIENTS-EL8_PACKAGE_NAME}-${FDB_PACKAGE_VERSION}${package_version_postfix}.el8.${CMAKE_SYSTEM_PROCESSOR}.rpm")
set(CPACK_RPM_CLIENTS-EL8_DEBUGINFO_FILE_NAME              "${CPACK_RPM_CLIENTS-EL8_PACKAGE_NAME}-${FDB_PACKAGE_VERSION}${package_version_postfix}.el8-debuginfo.${CMAKE_SYSTEM_PROCESSOR}.rpm")
...
set(CPACK_RPM_SERVER-EL8_PACKAGE_NAME                      "${CPACK_RPM_PACKAGE_NAME}-server")
set(CPACK_RPM_SERVER-EL8_FILE_NAME                         "${CPACK_RPM_SERVER-EL8_PACKAGE_NAME}-${FDB_PACKAGE_VERSION}${package_version_postfix}.el8.${CMAKE_SYSTEM_PROCESSOR}.rpm")
set(CPACK_RPM_SERVER-EL8_DEBUGINFO_FILE_NAME               "${CPACK_RPM_SERVER-EL8_PACKAGE_NAME}-${FDB_PACKAGE_VERSION}${package_version_postfix}.el8-debuginfo.${CMAKE_SYSTEM_PROCESSOR}.rpm")
set(CPACK_RPM_SERVER-EL8_PACKAGE_REQUIRES                  "${CPACK_RPM_CLIENTS-EL8_PACKAGE_NAME} = ${FDB_PACKAGE_VERSION}")
...
set(CPACK_RPM_SERVER-EL8_PRE_UNINSTALL_SCRIPT_FILE         ${CMAKE_SOURCE_DIR}/packaging/rpm/scripts/preunserver.sh)
set(CPACK_RPM_SERVER-EL8_USER_FILELIST                     "%config(noreplace) /etc/foundationdb/foundationdb.conf"
